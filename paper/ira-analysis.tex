...
attribution tests and have effectively implemented two state-of-the art paper
by Koppel et.~al.
...
minimum text length of 500 words. This was done using randomization to avoid
bias.
