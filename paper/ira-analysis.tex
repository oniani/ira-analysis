...
It should be noted that, despite the high accuracy of prediction, the NLP model
is rather sensitive to the input data and in some cases, even slight changes
