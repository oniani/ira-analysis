...
does not discuss political implications of the campaign, but attempts to
...
of a bigger dataset and, albeit LESS LIKELY, might not be a good
...
phrases related to race and race-based discrimination. Words related to ``taking
action'' such as ``join'', ``stop'', ``do'', ``follow'' etc. were used extensively
for persuasive purposes. These words in combination with other words like ``american'',
...
demonstrates a highly intelligent design of posts.
...
consistently comprising around 60\% of all posts. The year of the Presidential
