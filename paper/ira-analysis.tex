...
% Reduce padding before and after caption
...
generated over 25 million ad impressions.

\bigskip

Words associated with ``taking action'' such as ``join'', ``stop'', ``do'',
``follow'' etc.~were used extensively for persuasive purposes. Three most
commonly used words were ``black'', ``police'', and ``people''. These words in
combination with others such as ``American'', ``matters'', ``community'' etc.
further increased the persuasive quality of advertisements by metaphorically
connecting it with cultural and social identities of people and fueling hateful
rhetoric.
...
\texttt{Ad Text} value, 1643 were positive, 900 negative, and 933 neutral
