...
Only one ad mentioned ``Brexit'' and did so in a negative context, suggesting
that ``Brexit may be a threat to both, researchers think.'' The post pointed to
Dudeers.com,~\cite{nbcnews-dudeers} a site that went inactive in 2017.
